 ...
 * {@link Activity#onPostCreate(Bundle) onPostCreate} to synchronize the
...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
     ...
     */
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout,
                                 JellyToolbar toolbar, @StringRes int openDrawerContentDescRes,
                                 @StringRes int closeDrawerContentDescRes) {
     ...
     * animation.
     */
    public ActionBarDrawerToggle(Activity activity, JellyToolbar toolbar, DrawerLayout drawerLayout,
     ...
     * {@link Activity#onPostCreate(Bundle) onPostCreate} method to synchronize after
    ...
    static class ToolbarCompatDelegate implements Delegate {
        ...
        final JellyToolbar mToolbar;
        final Drawable mDefaultUpIndicator;
        final CharSequence mDefaultContentDescription;

        ToolbarCompatDelegate(JellyToolbar toolbar) {
            mToolbar = toolbar;
            mDefaultUpIndicator = toolbar.getToolbar().getNavigationIcon();
            mDefaultContentDescription = toolbar.getToolbar().getNavigationContentDescription();
        }

        @Override
        public void setActionBarUpIndicator(Drawable upDrawable, @StringRes int contentDescRes) {
            mToolbar.getToolbar().setNavigationIcon(upDrawable);
        ...
        public void setActionBarDescription(@StringRes int contentDescRes) {
            if (contentDescRes == 0) {
                mToolbar.getToolbar().setNavigationContentDescription(mDefaultContentDescription);
            } else {
                mToolbar.getToolbar().setNavigationContentDescription(contentDescRes);
            }
        }
